...
def getTimeInterval(spark):
    sqlRequest = """select
                    ...
                    from ( select 
                            ...
                            where ( day between '2019-06-21' and '2019-07-05' 
                                 or day between '2019-07-07' and '2019-07-21')
                              and cmd = 137
...
if __name__ == '__main__':
    ...
    visit_time_interval.write.mode("overwrite").saveAsTable("test.visit_time_intervalS_sjq") # 7698590